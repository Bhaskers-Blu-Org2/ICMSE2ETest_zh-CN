---
title: "映射 DDF 文件"
description: "本主题演示 OMA DM 设备描述框架 (DDF) 映射配置服务提供程序。 Windows 10 1511年版本中添加了该 CSP。"
MSHAttr:
...
translationtype: MT
---
# <a name="maps-ddf-file"></a>映射 DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF) 映射配置服务提供程序。 Windows 10 1511年版本中添加了该 CSP。
