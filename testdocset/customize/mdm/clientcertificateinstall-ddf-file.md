---
title: "ClientCertificateInstall DDF 文件"
description: "ClientCertificateInstall DDF 文件"
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/hardware
ms.assetid: 7F65D045-A750-4CDE-A1CE-7D152AA060CA
ms.openlocfilehash: 5e4db105c03ed400ed475af8fbb79a72c9037f37
ms.sourcegitcommit: d33e870dc4850bf0ea47fdae0d163b04c1c90f15
translationtype: MT
---
# <a name="clientcertificateinstall-ddf-file"></a>ClientCertificateInstall DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF) **ClientCertificateInstall**配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。
...
[ClientCertificateInstall 配置服务提供程序](clientcertificateinstall-csp.md)
