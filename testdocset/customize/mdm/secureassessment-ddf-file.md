---
title: "SecureAssessment DDF 文件"
description: "本主题演示 OMA DM 设备描述框架 (DDF) SecureAssessment 配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。"
MSHAttr:
...
translationtype: MT
---
# <a name="secureassessment-ddf-file"></a>SecureAssessment DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF) **SecureAssessment**配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。
