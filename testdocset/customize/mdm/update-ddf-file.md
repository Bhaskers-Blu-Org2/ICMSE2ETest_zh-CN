---
title: "更新 DDF 文件"
description: "更新 DDF 文件"
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/hardware
ms.assetid: E236E468-88F3-402A-BA7A-834ED38DD388
ms.openlocfilehash: 77a9adb9a0e09a2bcb12b2ba153faa4a678d7ee4
ms.sourcegitcommit: d33e870dc4850bf0ea47fdae0d163b04c1c90f15
translationtype: MT
---
# <a name="update-ddf-file"></a>更新 DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF)**更新**配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。
