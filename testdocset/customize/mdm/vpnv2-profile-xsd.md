...
description: "下面是 VPNv2 CSP Windows 10 以及一些配置文件示例中的 ProfileXML 节点的 XSD。"
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/hardware
ms.assetid: 2F32E14B-F9B9-4760-AE94-E57F1D4DFDB3
ms.openlocfilehash: 929745117172f38fb02ac54b21750ba994cfc3bc
ms.sourcegitcommit: d33e870dc4850bf0ea47fdae0d163b04c1c90f15
translationtype: MT
---
# <a name="profilexml-xsd"></a>ProfileXML XSD


下面是 VPNv2 CSP Windows 10 以及一些配置文件示例中的 ProfileXML 节点的 XSD。

## <a name="xsd-for-the-vpn-profile"></a>XSD VPN 配置文件
...
## <a name="native-profile-example"></a>本机配置文件示例
...
## <a name="plug-in-profile-example"></a>插件的配置文件示例
