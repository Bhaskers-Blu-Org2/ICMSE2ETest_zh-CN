---
title: "动态同步 DDF 文件"
description: "动态同步 DDF 文件"
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/hardware
ms.assetid: c4cd4816-ad8f-45b2-9b81-8abb18254096
ms.openlocfilehash: 569985a05c510d359e763221347f637877a7f5d3
ms.sourcegitcommit: d33e870dc4850bf0ea47fdae0d163b04c1c90f15
translationtype: MT
---
# <a name="activesync-ddf-file"></a>动态同步 DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF)**动态同步**配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。
...
[动态同步配置服务提供程序](activesync-csp.md)
