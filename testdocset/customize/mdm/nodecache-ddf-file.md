---
title: "NodeCache DDF 文件"
description: "NodeCache DDF 文件"
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/hardware
ms.assetid: d7605098-12aa-4423-89ae-59624fa31236
ms.openlocfilehash: d9652d53d553fbd090e52ae0d2e7a5d3441c584b
ms.sourcegitcommit: d33e870dc4850bf0ea47fdae0d163b04c1c90f15
translationtype: MT
---
# <a name="nodecache-ddf-file"></a>NodeCache DDF 文件


本主题演示 OMA DM 设备描述框架 (DDF) **NodeCache**配置服务提供程序。 DDF 文件只能用于提供 XML 的 OMA DM。
...
<MgmtTree xmlns:MSFT="http://schemas.microsoft.com/MobileDevice/DM">
  ...
  <Node>
    ...
    <DFProperties>
      ...
      <DFType>
        <MIME>com.microsoft/1.0/MDM/NodeCache</MIME>
      </DFType>
    </DFProperties>
    <Node>
      <NodeName></NodeName>
...
[NodeCache 配置服务提供程序](nodecache-csp.md)
