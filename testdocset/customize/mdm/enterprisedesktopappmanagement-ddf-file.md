...
description: "本主题演示 OMA DM 设备描述框架 (DDF) EnterpriseDesktopAppManagement 配置服务提供程序。"
MSHAttr:
...
本主题演示 OMA DM 设备描述框架 (DDF) **EnterpriseDesktopAppManagement**配置服务提供程序。

DDF 文件只能用于提供 XML 的 OMA DM。
