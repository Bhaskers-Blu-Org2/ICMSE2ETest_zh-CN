...
在请求正文，提供[RangeBorder](../resources/rangeborder.md)对象的 JSON 表示。


## <a name="response"></a>响应
如果成功，此方法返回`201, Created`响应代码和[RangeBorder](../resources/rangeborder.md)对象在响应正文中的。
