# <a name="create-acceptedsender"></a>创建 acceptedSender

AcceptedSender 列表中添加新用户或组。

指定的用户或组在`@odata.id`请求主体中。 接受发件人列表中的用户可以张贴到组的对话。 请确保已接受发件人和被拒绝的发件人列表中未指定的用户或组否则会发生错误。
