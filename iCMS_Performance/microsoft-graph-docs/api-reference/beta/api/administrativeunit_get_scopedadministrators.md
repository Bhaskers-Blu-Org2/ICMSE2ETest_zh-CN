# <a name="get-a-scopedadministrator"></a>获得 scopedAdministrator

检索特定的[scopedRoleMembership](../resources/scopedrolemembership.md)对象。
...
如果成功，此方法返回`200 OK`响应代码和请求的[scopedRoleMembership](../resources/scopedrolemembership.md)对象在响应正文中。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是示例请求。
<!-- {
