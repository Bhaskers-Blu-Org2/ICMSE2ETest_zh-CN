# <a name="range-intersection"></a>范围︰ 交集

获取表示指定范围的矩形交集的 range 对象。
...
| 参数    | 类型   |说明|
|:---------------|:--------|:----------|
|anotherRange|string|Range 对象或区域地址，用于确定范围的交集。|
...
```http
POST https://graph.microsoft.com/beta/me/drive/items/<id>/workbook/names(<name>)/range/Intersection
