...
目录设置模板表示在组织内可能从中创建设置的设置的模板。 此操作允许检索的 directorySettingTemplate 对象，包括可用的设置和默认值的属性。
...
如果成功，此方法返回`200 OK`响应代码和[directorySettingTemplate](../resources/directorysettingtemplate.md)对象在响应正文中的。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是示例请求。
<!-- {
