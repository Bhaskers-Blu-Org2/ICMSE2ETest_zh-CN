# <a name="list-chartpointscollection"></a>列表 ChartPointsCollection

检索的 chartpoint 对象的列表。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的[ChartPoint](../resources/chartpoint.md)对象的集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是示例请求。
<!-- {
