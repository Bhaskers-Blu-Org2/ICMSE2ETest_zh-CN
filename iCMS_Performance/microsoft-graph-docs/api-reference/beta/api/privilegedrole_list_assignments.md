# <a name="list-assignments"></a>列表中的工作分配

检索与该角色相关联的[privilegedRoleAssignment](../resources/privilegedroleassignment.md)对象的列表。 每个[privilegedRoleAssignment](../resources/privilegedroleassignment.md)表示给用户角色分配。
