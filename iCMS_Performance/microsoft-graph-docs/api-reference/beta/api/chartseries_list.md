# <a name="list-chartseriescollection"></a>列表 ChartSeriesCollection

检索的 chartseries 对象的列表。
...
如果成功，此方法返回`200 OK`响应代码和响应正文中的[ChartSeries](../resources/chartseries.md)对象的集合。
## <a name="example"></a>示例
##### <a name="request"></a>请求
下面是示例请求。
<!-- {
