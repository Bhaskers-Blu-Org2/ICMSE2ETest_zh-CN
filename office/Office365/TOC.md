...
# アプリを使用し、検索を簡単に行う
## [Web アプリケーション用の Office 用户界面 Toolkit](https://msdn.microsoft.com/en-us/library/mt484350.aspx)
## [JavaScript 的用户界面 コントロール](HowTo\javascript-controls.md)
## [アプリケーション起動プログラムへの接続します。](HowTo\connect-your-app-to-o365-app-launcher.md)
## [办公室 ストアにアプリを提出します。](https://msdn.microsoft.com/en-us/library/jj220033.aspx)
# OneNote
